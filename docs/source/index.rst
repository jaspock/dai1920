...
.. list-table::
    ...
    * - 13 Ene
      - Lo siguiente son algunas **normas y recomendaciones para los exámenes** de la asignatura del 24 de enero de 2020. 
        ...
        - Durante la realización del examen no habrá acceso a internet, excepto a esta `página con una copia de los materiales`_ de la asignatura (ubicación temporal) y al servidor de `entrega de prácticas`_ del departamento (para entregar tu solución al examen cuando acabes).
